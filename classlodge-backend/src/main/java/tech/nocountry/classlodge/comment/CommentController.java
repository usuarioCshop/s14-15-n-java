...
public class CommentController {
    ...
    @GetMapping(path="/{id}")
    @Operation(summary = "This endpoint retrieve a comment by its id.")
    ...
    @Operation(summary = "This endpoint retrieve all the comments in a course by course id.")
    ...
    @PutMapping("/{id}")
    @Operation(summary = "This endpoint update a comment by its id.")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "This endpoint delete a comment by its id.")
